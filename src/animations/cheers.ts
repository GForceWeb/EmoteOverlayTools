...
function createDrinkingAnimation(images: string[]): void {
    ...
    startCheersAnimation(avatar1, avatar2, beerMug1, beerMug2, beerPour, container);
}
...
function startCheersAnimation(avatar1: HTMLElement, avatar2: HTMLElement, mug1: HTMLElement, mug2: HTMLElement, beerPour: HTMLElement, container: HTMLElement): void {
    // Fade in avatars
    // @ts-ignore - GSAP is included via CDN
