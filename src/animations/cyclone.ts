...
function cyclone_animation(element: HTMLElement): void {
  ...
  tl.to(element, {
    x: centerX + Math.cos(angleRad + Math.PI / 4) * (innerWidth * 0.1),
    ...
    .to(
      ...
      "-=0.4"
    ) // Start 0.4s before previous tween ends
    .to(
      element,
      {
        x:
          centerX +
          Math.cos(angleRad + (Math.PI * 3) / 4) * (innerWidth * 0.18),
    ...
    .to(
      element,
      {
        x:
          centerX +
          Math.cos(angleRad + (Math.PI * 5) / 4) * (innerWidth * 0.24),
    ...
    .to(
      element,
      {
        x:
          centerX +
          Math.cos(angleRad + (Math.PI * 3) / 2) * (innerWidth * 0.26),
    ...
    .to(
      element,
      {
        x:
          centerX +
          Math.cos(angleRad + (Math.PI * 7) / 4) * (innerWidth * 0.28),
